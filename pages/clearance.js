  ...
  return (
    <div className="w-full max-w-3xl mx-auto text-gray-800 bg-white rounded-md shadow-md">
      ...
      <div className="px-4 py-6 text-lg prose sm:py-8 sm:px-6">
        <p>
          At the Port Macquarie Tender Centre, we understand the logistical and
          emotional challenges involved in downsizing a home or clearing a
          deceased estate.
        </p>
        <p>
          ...
          sell your items with minimal effort on your part, giving you one less
